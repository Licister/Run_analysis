...
* 36: "tbodyacc.std.x" : standard deviation of the time of the body acceleration signals for the X axis;
* 37: "tbodyacc.std.y" : standard deviation of the time of the body acceleration signals for the Y axis;
* 38: "tbodyacc.std.z" : standard deviation of the time of the body acceleration signals for the Z axis;
* 56: "fbodyacc.std.x" : standard deviation of the frequency of the body acceleration signals for the X axis;
* 57: "fbodyacc.std.y" : standard deviation of the frequency of the body acceleration signals for the Y axis;
* 58: "fbodyacc.std.z" : standard deviation of the frequency of the body acceleration signals for the Z axis;


**"gravityacc":** gravity acceleration signals. The variable name can assume the following combinations:
* 6: "tgravityacc.mean.x" : mean of the time of the gravity acceleration signals for the X axis;
